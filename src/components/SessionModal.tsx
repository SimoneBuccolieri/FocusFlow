...
export function SessionModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="glass p-1 rounded-3xl w-full max-w-lg shadow-2xl relative animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-300">
                <div className="bg-black/40 backdrop-blur-xl rounded-[1.25rem] border border-white/5 overflow-hidden">
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 p-2 rounded-full hover:bg-white/10 text-muted-foreground hover:text-white transition-all duration-200"
                    >
                        <X size={20} />
                    </button>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary/50 outline-none min-h-[80px] transition-all placeholder:text-muted-foreground/50 resize-none"
                                />
                            </div>
